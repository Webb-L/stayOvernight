...
@section('main')
    <div class="container mt-5">
        ...
        <form class="mt-5" action="{{route('overnight.update')}}" method="post">
            ...
            <div class="form-group mb-5 pd-5">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="exampleInputHostel1" name="hostel"
                       value="{{old('hostel')}}">
